		...
		while True:
			try:
				...
				if data:
					...
					##trace for package loss
					if self.frameNbr + 1 != rtpPacket.seqNum():
						self.lostFrameCounter += 1
						print ('!'*60 + "\nPACKET LOSS\n" + '!'*60)
					...
					if currFrameNbr == 1:
						self.beginTimestamp = rtpPacket.timestamp()
					self.endTimestamp = rtpPacket.timestamp()
					self.videoSize += len(rtpPacket.getPayload())
